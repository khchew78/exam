...
class PhotoGalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photo_gallery" do
    assert_difference('PhotoGallery.count') do
      post photo_galleries_url, params: { photo_gallery: { activity: @photo_gallery.activity, description: @photo_gallery.description } }
    end
  ...
  test "should update photo_gallery" do
    patch photo_gallery_url(@photo_gallery), params: { photo_gallery: { activity: @photo_gallery.activity, description: @photo_gallery.description } }
