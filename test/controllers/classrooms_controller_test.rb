...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post classrooms_url, params: { classroom: { branch: @classroom.branch, branch_id: @classroom.branch_id, name: @classroom.name } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { branch: @classroom.branch, branch_id: @classroom.branch_id, name: @classroom.name } }
