...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { branch_id: @test.branch_id, title: @test.title, year: @test.year } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { branch_id: @test.branch_id, title: @test.title, year: @test.year } }
